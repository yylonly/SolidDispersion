...
public class TrainningDisintegrationTime {
	...
	public static void main(String[] args) {
        ...
        try {
        	recordReadertrain.initialize(new FileSplit(new ClassPathResource("final/trainingset.csv").getFile()));
        ...
        try {
        	recordReadertest.initialize(new FileSplit(new ClassPathResource("final/testingset.csv").getFile()));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
