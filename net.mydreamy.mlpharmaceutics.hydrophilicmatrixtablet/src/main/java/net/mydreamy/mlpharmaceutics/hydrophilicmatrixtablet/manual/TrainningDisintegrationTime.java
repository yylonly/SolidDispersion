...
//        // cross-device access is used for faster model averaging over pcie
 //       .allowCrossDeviceAccess(true);
        ...
        try {
        	recordReadertrain.initialize(new FileSplit(new ClassPathResource("manual/trainingset.csv").getFile()));
        ...
        try {
        	recordReadertest.initialize(new FileSplit(new ClassPathResource("manual/testingset.csv").getFile()));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
