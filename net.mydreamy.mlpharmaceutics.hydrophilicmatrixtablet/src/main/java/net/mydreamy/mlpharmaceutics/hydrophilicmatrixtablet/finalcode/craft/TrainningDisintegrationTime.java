...
public class TrainningDisintegrationTime {
    ...
    //with api properties
    public static final int numInputs = 21;
...
//     public static final int numHiddenNodes = 60;
	...
	public static void main(String[] args) {
        ...
        try {
        	recordReadertrain.initialize(new FileSplit(new ClassPathResource("final-craft/trainset.csv").getFile()));
        ...
        try {
        	recordReadertest.initialize(new FileSplit(new ClassPathResource("final-craft/devset.csv").getFile()));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
...
//      terminationconditions.add(new MaxEpochsTerminationCondition(4000));
        ...
        terminationconditions.add(new MaxEpochsTerminationCondition(2600));
